    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('auction_listing', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='auctions.auctionlisting')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auction_listing', models.ManyToManyField(to='auctions.AuctionListing')),
            ],
        ),
        migrations.CreateModel(
            name='Bid',
